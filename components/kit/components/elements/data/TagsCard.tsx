  ...
  return (
    <div className="overflow-hidden shadow-lg rounded-2xl h-90 w-64  m-auto">
      ...
      <div className="bg-white w-full p-4 relative">
        ...
        <p className="text-gray-600 text-xs">Improve UI with beautiful templates and components for Tailwind css.</p>
        <div className="flex flex-wrap justify-starts items-center mt-6">
          ...
          <div className="text-xs mb-2 mr-2 py-1.5 px-4 text-gray-600 bg-purple-200 rounded-2xl">#tailwind</div>
