      ...
      <ul>
        <li className="flex items-center my-6 space-x-2">
          ...
          <div className="flex flex-col">
            <span className="text-sm text-gray-900 font-semibold dark:text-white ml-2">Charlie Rabiller</span>
        ...
        <li className="flex items-center my-6 space-x-2">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-sm text-gray-400 dark:text-gray-300 ml-2">No I think the dog is better...</span>
          </div>
        </li>
        <li className="flex items-center my-6 space-x-2">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-sm text-gray-400 dark:text-gray-300 ml-2">Seriously ? haha Bob is not a child !</span>
          </div>
        </li>
        <li className="flex items-center my-6 space-x-2">
