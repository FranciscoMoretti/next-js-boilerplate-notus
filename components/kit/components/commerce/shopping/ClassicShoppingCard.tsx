      ...
      <form className="flex-auto p-6">
        ...
        <div className="flex items-baseline mt-4 mb-6 text-gray-700 dark:text-gray-300">
          <div className="space-x-2 flex">
            ...
            <label className="text-center">
              <input className="w-6 h-6 flex items-center justify-center" name="size" type="radio" value="s" />S
            </label>
            <label className="text-center">
              <input className="w-6 h-6 flex items-center justify-center" name="size" type="radio" value="m" />M
            </label>
            <label className="text-center">
              <input className="w-6 h-6 flex items-center justify-center" name="size" type="radio" value="l" />L
            </label>
            <label className="text-center">
              <input className="w-6 h-6 flex items-center justify-center" name="size" type="radio" value="xl" />
              XL
            </label>
          </div>
