  ...
  return (
    <div className={`bg-white dark:bg-gray-800 w-72 ${props.withShadow ? 'shadow-lg' : ''} mx-auto rounded-xl p-4`}>
      <p className={`text-gray-600 dark:text-white`}>
        <span className="font-bold text-indigo-500 text-lg">“</span>To get social media testimonials like these, keep
        your customers engaged with your social media accounts by posting regularly yourself
