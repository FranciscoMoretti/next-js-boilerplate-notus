    ...
    <div className="bg-lightblue py-20 px-4">
      <div className="mx-auto max-w-6xl flex flex-col md:flex-row">
        ...
        <dl className="w-full md:w-2/3">
          ...
          <dd className="mb-16">
            <p>
              We don’t. Valohai isn’t a data science platform; it's a Machine Learning Management Platform that handles
              the whole ML pipeline from feature extraction, to training of your model and to deploying it into
          ...
          <dd className="mb-16">
            <p>
              ...
              agreements. Valohai doesn't charge anything on top of the per-user license fee. If you don't have a cloud
              provider, you can use our AWS, GCP and Azure accounts, and we'll only charge you for what you use.
            </p>
          </dd>
        </dl>
      </div>
