          ...
          <ul className="mt-10">
            <li>
              <div className="flex">
                ...
                <div className="ml-4">
                  <h5 className="text-lg leading-6 text-gray-900 dark:text-white font-bold">One-look dashboard</h5>
            ...
            <li className="mt-10">
              <div className="flex">
                ...
                <div className="ml-4">
                  <h5 className="text-lg leading-6 text-gray-900 dark:text-white font-bold">Orders, managed</h5>
                  <p className="mt-2 text-base leading-6 text-gray-500 dark:text-gray-300">
