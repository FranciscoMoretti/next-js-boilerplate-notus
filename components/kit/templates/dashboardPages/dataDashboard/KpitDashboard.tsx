      ...
      <div className="flex items-start justify-between">
              ...
              <div>
                ...
                >
                  ...
                  <span className="mx-2 text-sm font-normal">
                    Refered Projects{' '}
                    <span className="p-1 ml-4 rounded-lg w-4 h-2 bg-gray-200 text-gray-400 text-xs">0</span>
                  </span>
                </a>
                <a
                  className="w-full text-gray-400 flex items-center pl-6 p-2 my-2 transition-colors duration-200 justify-start hover:text-gray-800 border-l-4 border-transparent"
        ...
        <div className="flex flex-col w-full md:space-y-4">
          ...
          <div className="overflow-auto h-screen pb-24 px-4 md:px-6">
            <h1 className="text-4xl font-semibold text-gray-800 dark:text-white">Good afternoom, Charlie</h1>
